...
TEST_CASE("StatementParser: isAssignStmt") {
    ...
    REQUIRE(StatementParser({
                ...
                .isAssignStmt());
    REQUIRE(StatementParser({"x", "=", "(", "5", "+", "10", ")", "*", "(", "5", "/", "10", ")"})
                .isAssignStmt());
    REQUIRE(
        StatementParser({"x", "=", "(", "(", "5", "+", "10", ")", "*", "(", "5", "/", "10", ")"})
            .isAssignStmt());
    ...
    REQUIRE_FALSE(StatementParser({
                      ...
                      .isAssignStmt());
    // REQUIRE_FALSE(StatementParser({"=", "5", }).isAssignStmt());
    // REQUIRE_FALSE(StatementParser({"x", "="}).isAssignStmt());
}
